        ...
        return (<div className="mainCont">
            <Router><Nav></Nav>
                ...
                <div className="mainContent" >
                    <Switch>
                        <Route exact path='/'><Mario></Mario></Route>
                        <Route path='/formRegister'> <Modal></Modal></Route>
                        <Route path='/counter'>
                            <div className="step-counter"><button onClick={this.incrementCount}>Counter</button>
